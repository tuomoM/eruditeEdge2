...
ASSET_VERSION = os.environ.get("ASSET_VERSION", "20260810-vocabulary-hub")
...
OPENAI_MAINTENANCE_MODEL = os.environ.get("OPENAI_MAINTENANCE_MODEL", "")
OPENAI_MAINTENANCE_TIMEOUT_SECONDS = int(
    os.environ.get("OPENAI_MAINTENANCE_TIMEOUT_SECONDS", "300")
)
OPENAI_DOMAIN_MODEL_MAX_OUTPUT_TOKENS = int(
    os.environ.get("OPENAI_DOMAIN_MODEL_MAX_OUTPUT_TOKENS", "12000")
)
SYNONYM_NET_CLOZE_JOBS_ENABLED = _env_bool("SYNONYM_NET_CLOZE_JOBS_ENABLED", True)
