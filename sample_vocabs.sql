...
SELECT id, 'omnipresent' FROM vocabulary_entries WHERE word = 'Ubiquitous' AND context = '';
INSERT OR IGNORE INTO vocabulary_synonyms (vocabulary_id, synonym)
SELECT id, 'pervasive' FROM vocabulary_entries WHERE word = 'Ubiquitous' AND context = '';
INSERT OR IGNORE INTO vocabulary_synonyms (vocabulary_id, synonym)
...
INSERT OR IGNORE INTO vocabulary_synonyms (vocabulary_id, synonym)
SELECT id, 'short-sighted' FROM vocabulary_entries WHERE word = 'myopic' AND context = 'Medical';
INSERT OR IGNORE INTO vocabulary_synonyms (vocabulary_id, synonym)
SELECT id, 'narrow-minded' FROM vocabulary_entries WHERE word = 'myopic' AND context = 'Medical';
INSERT OR IGNORE INTO vocabulary_synonyms (vocabulary_id, synonym)
...
FROM vocabulary_entries WHERE word = 'Ubiquitous' AND context = '';
INSERT OR IGNORE INTO vocabulary_examples (vocabulary_id, example_sentence, example_order)
...
FROM vocabulary_entries WHERE word = 'myopic' AND context = 'Medical';
INSERT OR IGNORE INTO vocabulary_examples (vocabulary_id, example_sentence, example_order)
